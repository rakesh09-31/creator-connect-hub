...
-- File: 20260826000000_omnicraft_complete_stabilization.sql
-- ============================================================================
...
-- Step 2: Convert existing Text ID columns to UUID and sanitize data
DO $$ BEGIN
    -- profiles
...
-- 4.12 Post views / video analytics
...
-- 4.18 Skill swap listing skills & specialties
...
-- 4.20 Skill swap assessments & questions
...
-- Step 5: Foreign Keys & Relationships
DO $$ BEGIN
...
-- Step 6: Enable RLS & Apply Production Policies
...
-- Step 7: Stored Procedures & RPC Functions
...
console.log('Successfully wrote 20260826000000_omnicraft_complete_stabilization.sql');
